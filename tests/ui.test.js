...
vi.mock('lucide', () => ({
    createIcons: vi.fn(),
    Trash2: {}, Pencil: {}, AlertTriangle: {}, BookOpen: {}, 
    GraduationCap: {}, Plus: {}, ArrowLeft: {}, Moon: {}, 
    PlusCircle: {}, Search: {}, Settings: {}, X: {}, 
...
describe('UI Layer (jsdom)', () => {
    ...
    describe('render more complex cases', () => {
        it('does not re-animate if already rendered', () => {
            document.body.innerHTML = '<div id="subjectsContainer"><div>Existing</div></div><div id="emptyState" class="hidden"></div>';
    ...
    describe('safeColor', () => {
        it('returns default color for invalid hex', () => {
            document.body.innerHTML = '<div id="subjectsContainer"></div><div id="emptyState" class="hidden"></div>';
